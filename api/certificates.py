...
async def emit_certificate(
    ...
    # Solo el estudiante puede pedir la emisión de SU certificado.
    # (El staff lo hace a través de un endpoint admin futuro, fuera de alcance MVP.)
    if not isinstance(current_user, Student):
        raise HTTPException(
            status_code=status.HTTP_403_FORBIDDEN,
            detail="Solo el estudiante puede solicitar la emisión de su propio certificado.",
        )
